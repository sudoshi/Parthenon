# ──────────────────────────────────────────────────────────────────
# Extracted prediction pipeline for callr background execution.
# Called by: r-runtime/api/jobs.R prediction worker function
# Returns: the same result structure as POST /analysis/prediction/run
#
# NOTE: Does NOT use safe_execute() — errors propagate to callr
# and are caught by get_job_status() in async_jobs.R.
# ──────────────────────────────────────────────────────────────────
...
run_prediction_pipeline <- function(spec, logger) {
