# ──────────────────────────────────────────────────────────────────
# Extracted SCCS pipeline for callr background execution.
# Called by: r-runtime/api/jobs.R SCCS worker function
# Returns: the same result structure as POST /analysis/sccs/run
#
...
run_sccs_pipeline <- function(spec, logger) {
