...
def write_env_file(
    ...
    if edition.tier == "enterprise":
        ...
        lines.extend([
            ...
            "# OAuth/SAML credentials — populated by authentik.py bootstrap",
            "# Do not edit manually — re-run installer to regenerate",
            f"GRAFANA_OAUTH_CLIENT_ID={config.grafana_oauth_client_id}",
            f"GRAFANA_OAUTH_CLIENT_SECRET={config.grafana_oauth_client_secret}",
            f"SUPERSET_OAUTH_CLIENT_ID={config.superset_oauth_client_id}",
            f"SUPERSET_OAUTH_CLIENT_SECRET={config.superset_oauth_client_secret}",
            f"PGADMIN_OAUTH_CLIENT_ID={config.pgadmin_oauth_client_id}",
            f"PGADMIN_OAUTH_CLIENT_SECRET={config.pgadmin_oauth_client_secret}",
            f"DATAHUB_OAUTH_CLIENT_ID={config.datahub_oauth_client_id}",
            f"DATAHUB_OAUTH_CLIENT_SECRET={config.datahub_oauth_client_secret}",
            f"PORTAINER_OAUTH_CLIENT_ID={config.portainer_oauth_client_id}",
            f"PORTAINER_OAUTH_CLIENT_SECRET={config.portainer_oauth_client_secret}",
            f"WAZUH_SAML_EXCHANGE_KEY={config.wazuh_saml_exchange_key}",
            "",
