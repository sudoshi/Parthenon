    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-success px-4 py-2.5 text-sm font-medium text-surface-base hover:bg-success disabled:opacity-50 transition-colors"
        >
        ...
        <div className="space-y-3">
          ...
          {showScenarioForm && (
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-lg bg-success px-3 py-1.5 text-xs font-medium text-surface-base hover:bg-success transition-colors"
              >
                Add
              </button>
              <button
            ...
            >
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg bg-success px-3 py-1.5 text-xs font-medium text-surface-base hover:bg-success disabled:opacity-50 transition-colors"
                >
