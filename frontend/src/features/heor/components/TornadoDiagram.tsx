              ...
              return (
                <div className={TOOLTIP_CLS}>
                  ...
                  <div className="space-y-0.5 text-xs">
                    ...
                    <p className="text-text-secondary">
                      Low ICER: <span className="font-mono text-success">${d.lowIcer?.toLocaleString() ?? "—"}</span>
                    </p>
                    <p className="text-text-secondary">
                      High ICER: <span className="font-mono text-critical">${d.highIcer?.toLocaleString() ?? "—"}</span>
                    </p>
                    <p className="text-text-secondary">
                      ICER Range: <span className="font-mono font-semibold text-text-primary">±${formatCompact(d.range / 2)}</span>
                    </p>
                  </div>
                </div>
              );
