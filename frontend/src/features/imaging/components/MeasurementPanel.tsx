      ...
      <div className="rounded-lg border border-[#A78BFA]/30 bg-[#A78BFA]/5 p-4 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-[#A78BFA] px-4 py-2 text-sm font-medium text-text-primary hover:bg-[#8B5CF6] disabled:opacity-50 transition-colors"
          >
