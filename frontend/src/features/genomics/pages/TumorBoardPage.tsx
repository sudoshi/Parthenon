      ...
      <div className="rounded-lg border border-border-default bg-surface-raised p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={!personId}
            className="inline-flex items-center gap-1.5 rounded-lg bg-success px-4 py-2 text-sm font-medium text-surface-base hover:bg-success disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            <Search size={14} />
            Load Panel
          </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 rounded-lg border border-border-default bg-surface-raised">
              <div className="px-4 py-3 border-b border-border-default flex items-center gap-2">
                <Dna size={14} className="text-[var(--domain-observation)]" />
                      ...
                      {panel.variants.map((v) => {
                        ...
                        return (
                          <tr key={v.id} className="hover:bg-surface-overlay transition-colors">
                            <td className="px-3 py-2.5 font-semibold text-[var(--domain-observation)]">
                              {v.gene ?? "—"}
                            </td>
