        ...
        <div>
          <div className="flex items-center justify-end gap-2 px-3 py-2 border-b border-border-default">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium bg-primary text-white hover:bg-primary/80 disabled:opacity-50"
            >
        ...
        <div>
          <div className="flex items-center justify-end gap-2 px-3 py-2 border-b border-border-default">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium bg-zinc-700 text-white hover:bg-zinc-600 disabled:opacity-50"
            >
