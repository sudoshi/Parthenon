    ...
    <div className="rounded-lg border border-border-default bg-surface-base p-4">
      ...
      <div className="flex flex-wrap items-center gap-1.5 text-[14px] leading-[2.2]">
        ...
        <select
          ...
          className="rounded border border-surface-highlight bg-surface-overlay px-2.5 py-1 text-[13px] text-success outline-none"
        >
        ...
        <input
          ...
          className="w-[40px] rounded border border-surface-highlight bg-surface-overlay px-2 py-1 text-center text-[13px] text-accent outline-none focus:border-accent"
        />
        <select
          value={rule.domain}
