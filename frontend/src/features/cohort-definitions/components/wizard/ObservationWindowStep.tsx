        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            ...
            <input
              ...
              className="w-[100px] rounded-md border border-surface-highlight bg-surface-overlay px-3 py-2 text-center text-[13px] text-accent outline-none focus:border-accent"
            />
