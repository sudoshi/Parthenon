            ...
            <button
              ...
              className={`rounded-md p-2.5 text-left transition-colors ${
                isSelected
                  ...
                  : "border border-border-default bg-surface-base hover:border-surface-highlight"
              }`}
            >
        ...
        <div className="rounded-md bg-surface-overlay p-3">
          <div className="flex flex-wrap items-center gap-1.5 text-[13px]">
            ...
            <input
              ...
              className="w-[50px] rounded border border-surface-highlight bg-surface-base px-2 py-1 text-center text-accent outline-none focus:border-accent"
            />
            ...
            <select
              ...
              className="rounded border border-surface-highlight bg-surface-base px-2 py-1 text-success outline-none"
            >
