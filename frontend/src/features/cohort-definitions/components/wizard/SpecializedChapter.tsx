  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          <Dna size={24} className="mx-auto mb-1.5 text-[var(--domain-observation)]" />
      ...
      {selectedSpecialized.includes("genomic") && (
        <div className="rounded-lg border border-border-default bg-surface-base p-4">
          <h4 className="mb-3 text-[13px] font-medium text-[var(--domain-observation)]">Genomic Criteria</h4>
