          ...
          {endStrategy.type === "fixed" && (
            <div className="mt-3 ml-[26px] flex items-center gap-2">
              ...
              <input
                ...
                className="w-[70px] rounded border border-surface-highlight bg-surface-base px-2 py-1 text-center text-[13px] text-accent outline-none focus:border-accent"
              />
            ...
            <div className="mt-3 ml-[26px] flex flex-col gap-3" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-[60px] rounded border border-surface-highlight bg-surface-base px-2 py-1 text-center text-[13px] text-accent outline-none focus:border-accent"
                />
