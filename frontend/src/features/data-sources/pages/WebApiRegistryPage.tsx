    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-3 py-2 text-sm font-medium text-surface-base hover:bg-accent-light transition-colors"
        >
          <Plus size={14} />
          Add Registry
        </button>
        ...
        <div className="rounded-lg border border-accent/30 bg-surface-raised p-5 space-y-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-3 py-1.5 text-xs font-medium text-surface-base hover:bg-accent-light disabled:opacity-50"
            >
