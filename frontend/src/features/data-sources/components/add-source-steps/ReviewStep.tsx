  ...
  return (
    <div className="space-y-5">
      ...
      <button
        ...
        onClick={onSubmit}
        disabled={isLoading}
        className="flex w-full items-center justify-center gap-2 rounded-lg bg-critical px-4 py-3 text-sm font-semibold text-white hover:bg-critical disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
      >
