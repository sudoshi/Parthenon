          ...
          {inputMode === "json" ? (
            <div className="space-y-2">
              ...
              <textarea
                ...
                spellCheck={false}
                className={cn(
                  "w-full rounded-md border bg-surface-base px-3 py-2.5 font-mono text-xs text-text-secondary placeholder-surface-highlight outline-none resize-y transition-colors",
                  jsonError
