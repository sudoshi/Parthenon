      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border-default">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs rounded bg-surface-elevated hover:bg-surface-accent/80 text-text-secondary transition-colors disabled:opacity-50"
          >
            <RefreshCw
