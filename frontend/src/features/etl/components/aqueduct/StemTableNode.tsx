...
function StemTableNodeComponent({ data }: NodeProps) {
  ...
  return (
    <div className="rounded-lg border-2 border-dashed border-[#A855F7] bg-[#1a0f2e] px-4 py-3 min-w-[180px]">
      <Handle type="target" position={Position.Left} className="!w-3 !h-3 !bg-[#A855F7] !border-[#A855F7]" />
      <div className="text-sm font-semibold text-[#A855F7]">Stem Table</div>
