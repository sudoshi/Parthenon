...
export default function StudyCreatePage() {
  ...
  const renderScience = () => (
    <div className="space-y-5">
      {/* AI Suggest Banner */}
      <div className="flex items-center justify-between rounded-lg border border-[var(--domain-observation)]/20 bg-[var(--domain-observation)]/5 px-4 py-3">
        <div className="flex items-center gap-2">
          <Sparkles size={16} className="text-[var(--domain-observation)]" />
