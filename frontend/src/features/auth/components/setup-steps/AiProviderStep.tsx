...
function OtherProviderRow({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-[#232328] bg-[#1A1A1E] px-4 py-3">
      <div className="flex items-center gap-3">
        <div className="flex h-8 w-8 items-center justify-center rounded-md bg-[#232328]">
          <Bot size={14} className="text-[#8A857D]" />
        </div>
        <div>
          <span className="text-sm font-medium text-[#F0EDE8]">{provider.display_name}</span>
      ...
      <button
        ...
        className="rounded-md border border-[#323238] px-3 py-1 text-xs font-medium text-[#8A857D] transition-colors hover:border-[#C9A227]/40 hover:text-[#C9A227] disabled:opacity-50"
      >
        Switch to this
      </button>
    </div>
...
export function AiProviderStep({ onConfigured }: Props) {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-2 text-sm text-[#8A857D]">Loading AI providers...</span>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-lg font-semibold text-[#F0EDE8]">AI Provider Configuration</h3>
      ...
      {activeProvider && meta && (
        <div className="rounded-lg border border-[#232328] bg-[#1A1A1E] p-5 space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-md border border-[#232328] bg-[#0E0E11] px-3 py-2 pr-10 text-sm text-[#F0EDE8] focus:outline-none focus:ring-2 focus:ring-[#C9A227]/50"
                    value={apiKey}
                    onChange={(e) => {
            ...
            {meta.hasBaseUrl && (
              <div>
                ...
                <input
                  type="text"
                  className="w-full rounded-md border border-[#232328] bg-[#0E0E11] px-3 py-2 text-sm text-[#F0EDE8] font-mono focus:outline-none focus:ring-2 focus:ring-[#C9A227]/50"
                  value={baseUrl}
                  onChange={(e) => {
          ...
          <div className="flex flex-wrap items-center gap-3">
            {dirty && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-md bg-[#C9A227] px-3 py-1.5 text-sm font-medium text-[#0E0E11] hover:bg-[#D4AE3A] disabled:opacity-50"
              >
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-md border border-[#323238] px-3 py-1.5 text-sm font-medium text-[#8A857D] transition-colors hover:border-[#C9A227]/40 hover:text-[#F0EDE8] disabled:opacity-50"
            >
      ...
      {otherProviders.length > 0 && (
        <div>
          <button
            ...
            className="flex items-center gap-1.5 text-sm text-[#5A5650] hover:text-[#8A857D] transition-colors"
          >
