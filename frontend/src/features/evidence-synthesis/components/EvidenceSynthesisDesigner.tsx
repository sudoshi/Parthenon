    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-[#232328] bg-[#151518] p-4 space-y-3">
        ...
        {design.method === "bayesian" && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3">
            ...
            <div>
              <label className="block text-[10px] text-[#5A5650] mb-1">Burn-in</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-[10px] text-[#5A5650] mb-1">Sub-sample</label>
              <input
                type="number"
      ...
      <div className="rounded-lg border border-[#232328] bg-[#151518] p-4 space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-[#F0EDE8]">Site Estimates</h3>
          <button
            type="button"
            onClick={addEstimate}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-[1fr_120px_120px_32px] gap-2 px-1">
            <span className="text-[10px] uppercase tracking-wider text-[#5A5650] font-semibold">Site Name</span>
            <span className="text-[10px] uppercase tracking-wider text-[#5A5650] font-semibold">Log(RR)</span>
            <span className="text-[10px] uppercase tracking-wider text-[#5A5650] font-semibold">SE(Log RR)</span>
            <span />
          </div>
            ...
            <div key={idx} className="grid grid-cols-[1fr_120px_120px_32px] gap-2 items-center">
              ...
              {design.estimates.length > 2 ? (
                <button
                  ...
                  className="text-[#8A857D] hover:text-[#E85A6B] transition-colors flex items-center justify-center"
                >
                  <X size={14} />
                </button>
              ) : (
        ...
        <div className="mt-3 pt-3 border-t border-[#232328]">
          <p className="text-[10px] uppercase tracking-wider text-[#5A5650] font-semibold mb-2">
