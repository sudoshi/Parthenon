...
export function AresBreadcrumb({ activeSection, onBack }: AresBreadcrumbProps) {
  ...
  return (
    <div className="sticky top-0 z-10 flex items-center gap-2 rounded-lg border border-[#252530] bg-surface-raised px-4 py-2 text-sm">
      <button
        type="button"
        onClick={onBack}
        className="text-accent hover:text-[#e0b82e] transition-colors"
      >
        Ares
      </button>
