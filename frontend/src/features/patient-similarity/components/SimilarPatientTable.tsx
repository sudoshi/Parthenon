...
function SharedFeaturePills({ category, icon, label }: {
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center gap-1.5 text-[11px] font-semibold text-text-ghost uppercase tracking-[0.5px]">
        {icon}
        {label}
  ...
  if (patients.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <p className="text-sm text-text-muted">No similar patients found for the given criteria.</p>
      </div>
    );
  }
        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 z-20">
            <tr className="bg-surface-overlay border-b border-border-default">
              ...
              <th className="px-3 py-2.5 text-left text-[11px] font-semibold text-text-ghost uppercase tracking-[0.5px] w-12">
                #
              </th>
              <th className="px-3 py-2.5 text-left text-[11px] font-semibold text-text-ghost uppercase tracking-[0.5px]">
                Score
              </th>
              <th className="px-3 py-2.5 text-left text-[11px] font-semibold text-text-ghost uppercase tracking-[0.5px]">
                Patient
              ...
              <th className="px-3 py-2.5 text-right text-[11px] font-semibold text-text-ghost uppercase tracking-[0.5px] w-20">
                Compare
              </th>
            </tr>
          </thead>
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 text-right" onClick={(e) => e.stopPropagation()}>
                      {compareUrl ? (
                        ...
                        <span className="text-xs text-surface-highlight">--</span>
                      )}
                    </td>
                  </tr>
                  {/* Expanded detail row */}
                  {isExpanded && hasDetails && (
                    <tr className="border-b border-border-default/50 bg-surface-base">
                      <td />
