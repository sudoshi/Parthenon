    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-1 text-xs">
          <span className="text-zinc-500 mr-1">ICU:</span>
        ...
        {/* Mortality toggle */}
        <div className="flex items-center gap-1 text-xs">
          <span className="text-zinc-500 mr-1">Mortality:</span>
        ...
        {/* LOS inputs */}
        <div className="flex items-center gap-1 text-xs">
          <span className="text-zinc-500">LOS:</span>
          <input type="number" placeholder="Min" min={0} step={1}
            ...
            className="w-14 px-1.5 py-1 rounded bg-[#0E0E11] border border-zinc-800 text-zinc-300 text-xs focus:border-[#9B1B30] focus:outline-none transition-colors" />
          ...
          <input type="number" placeholder="Max" min={0} step={1}
            ...
            className="w-14 px-1.5 py-1 rounded bg-[#0E0E11] border border-zinc-800 text-zinc-300 text-xs focus:border-[#9B1B30] focus:outline-none transition-colors" />
          <span className="text-zinc-600 text-[10px]">days</span>
        </div>
      ...
      {showClinical && (
        <div className="flex items-center gap-2">
          <span className="text-xs text-zinc-500">Diagnosis:</span>
          <input type="text" placeholder="Search ICD code or description..."
            ...
            className="w-64 px-2 py-1 rounded bg-[#0E0E11] border border-zinc-800 text-zinc-300 text-xs placeholder:text-zinc-600 focus:border-[#9B1B30] focus:outline-none transition-colors" />
        </div>
      )}
    </div>
  );
