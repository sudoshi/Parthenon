      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-1 text-xs">
          ...
          <input type="number" placeholder="Min" min={0} step={1}
            ...
            className="w-14 px-1.5 py-1 rounded bg-[#0E0E11] border border-border-default text-[#C5C0B8] text-xs focus:border-[#9B1B30] focus:outline-none focus:ring-1 focus:ring-[#9B1B30]/30 transition-colors" />
      ...
      {showClinical && (
        <div className="flex items-center gap-2">
          ...
          <input type="text" placeholder="Search ICD code or description..."
            ...
            className="w-64 px-2 py-1 rounded bg-[#0E0E11] border border-border-default text-[#C5C0B8] text-xs placeholder:text-[#5A5650] focus:border-[#9B1B30] focus:outline-none focus:ring-1 focus:ring-[#9B1B30]/30 transition-colors" />
        </div>
      )}
    </div>
  );
