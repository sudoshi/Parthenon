      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-1 text-xs">
          ...
          <input type="number" placeholder="Min" min={0} step={1}
            ...
            className="w-14 px-1.5 py-1 rounded bg-surface-base border border-zinc-800 text-text-secondary text-xs focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30 transition-colors" />
      ...
      {showClinical && (
        <div className="flex items-center gap-2">
          ...
          <input type="text" placeholder="Search ICD code or description..."
            ...
            className="w-64 px-2 py-1 rounded bg-surface-base border border-zinc-800 text-text-secondary text-xs placeholder:text-text-ghost focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30 transition-colors" />
        </div>
      )}
    </div>
  );
