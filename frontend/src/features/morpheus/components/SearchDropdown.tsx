    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-700 bg-zinc-900 pl-9 pr-3 py-2 text-sm text-text-secondary placeholder:text-text-ghost focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary"
        />
      </div>
