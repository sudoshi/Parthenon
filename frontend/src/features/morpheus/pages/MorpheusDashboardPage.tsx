      ...
      <div className="flex items-baseline justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={() => navigate(`/morpheus/journey?icu=true${ds}`)}
            className="rounded-lg bg-primary/80 px-3 py-1.5 text-xs font-medium text-white hover:bg-primary transition-colors">
            ICU Patients
          </button>
          <button onClick={() => navigate(`/morpheus/journey?deceased=true${ds}`)}
            className="rounded-lg bg-zinc-800 px-3 py-1.5 text-xs font-medium text-text-secondary hover:bg-zinc-700 transition-colors">
            Deceased
          </button>
          <button onClick={() => navigate(`/morpheus/journey${dsQ}`)}
            className="rounded-lg border border-zinc-800 px-3 py-1.5 text-xs font-medium text-text-muted hover:text-text-secondary hover:border-zinc-600 transition-colors">
            Browse All
          </button>
        </div>
      </div>
