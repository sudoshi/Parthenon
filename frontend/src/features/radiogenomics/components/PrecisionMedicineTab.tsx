  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-64">
        <Loader2 size={24} className="animate-spin text-[var(--domain-observation)]" />
      </div>
    );
  }
                ...
                <Fragment key={i}>
                  <tr className="group">
                    <td className="px-4 py-2.5">
                      <span className="text-xs font-semibold text-[var(--domain-observation)]">{c.gene_symbol}</span>
                    </td>
                    <td className="px-4 py-2.5">
            ...
            {displayVariants.map((v) => {
              ...
              return (
                <tr key={v.id} className="group hover:bg-surface-overlay transition-colors">
                  <td className="px-4 py-2.5">
                    <span className="text-xs font-semibold text-[var(--domain-observation)]">{v.gene_symbol}</span>
                  </td>
                  <td className="px-4 py-2.5">
