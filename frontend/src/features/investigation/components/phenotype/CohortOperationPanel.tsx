...
export function CohortOperationPanel({
  ...
  return (
    <div className="flex flex-col gap-5 rounded-xl border border-zinc-700/50 bg-[#0E0E11] p-4">
      {/* Header */}
      <div>
      ...
      {vennCircles.length >= 2 && (
        <div className="flex justify-center rounded-lg border border-zinc-800 bg-[#151518] py-4">
          <VennDiagram
            circles={vennCircles}
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          className="w-full rounded border border-zinc-700 bg-zinc-800/60 px-3 py-1.5 text-xs text-zinc-200 focus:border-[#2DD4BF]/60 focus:outline-none disabled:opacity-50"
        >
          <option value="">
      ...
      {result && (
        <div className="flex flex-col gap-4">
          ...
          {result.attrition.length > 0 && (
            <div className="rounded-lg border border-zinc-800 bg-[#151518] p-4">
