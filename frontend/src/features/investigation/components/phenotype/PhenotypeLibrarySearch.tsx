    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-zinc-800/60 border border-zinc-700 rounded pl-8 pr-3 py-2 text-xs text-zinc-200 placeholder:text-zinc-500 focus:outline-none focus:border-[#2DD4BF]/60"
        />
        {loading && (
