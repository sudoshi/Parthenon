...
export function MarkdownRenderer({
  ...
  return (
    <div className="wiki-prose max-w-none text-sm leading-relaxed text-text-secondary
      ...
      [&_a]:text-success [&_a]:underline [&_a]:underline-offset-2 [&_a]:transition-colors hover:[&_a]:text-[#26B8A5]
    ">
      <ReactMarkdown
        ...
        components={{
          a: ({ href, children }) => {
            if (href?.startsWith("/__wiki__/")) {
              ...
              return (
                <button
                  ...
                  className="inline rounded px-1 text-success underline underline-offset-2 transition-colors hover:bg-success/10 hover:text-[#26B8A5]"
                >
                  {children}
                </button>
              );
            ...
            return (
              <a href={href} target="_blank" rel="noreferrer" className="text-success underline underline-offset-2 transition-colors hover:text-[#26B8A5]">
                {children}
              </a>
            );
          },
