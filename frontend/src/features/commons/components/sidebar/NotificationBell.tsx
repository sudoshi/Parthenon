  ...
  return (
    <div ref={triggerRef} className="relative">
      ...
      {open && createPortal(
        <div
          ref={panelRef}
          className="fixed z-[220] w-96 overflow-hidden rounded-2xl border border-white/10 bg-surface-raised shadow-[0_24px_80px_rgba(0,0,0,0.55)] ring-1 ring-black/35 backdrop-blur-xl"
          role="dialog"
          aria-label="Notifications"
        >
          ...
          <div className="max-h-[28rem] overflow-y-auto bg-surface-raised">
