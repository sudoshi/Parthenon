...
export function OnlineUsers({ users }: OnlineUsersProps) {
  ...
  return (
    <div className="border-t border-white/[0.06] px-3 py-3">
      ...
      {currentUser && (
        <div className="mb-3 rounded-xl border border-border-default bg-[#111115] px-3 py-2.5">
      ...
      <div className="flex flex-col gap-0.5">
        {visibleUsers.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border-default bg-[#111115] px-3 py-3 text-[12px] text-muted-foreground">
