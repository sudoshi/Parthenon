      ...
      <div className="max-w-[85%] min-w-0">
        ...
        <div className="px-3.5 py-2.5 rounded-2xl rounded-bl-sm bg-muted">
          {entry.dataResult ? (
            ...
            <div className="prose prose-sm prose-invert max-w-none text-[13px] text-foreground leading-relaxed [&_p]:my-1 [&_ul]:my-2 [&_ol]:my-2 [&_li]:my-0.5 [&_pre]:bg-surface-base [&_pre]:border [&_pre]:border-white/[0.06] [&_pre]:rounded-md [&_pre]:p-3 [&_code]:text-teal-400">
        ...
        <div className="shrink-0 px-4 py-3 border-t border-white/[0.06] bg-gradient-to-t from-black/20 to-transparent">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 h-10 px-3.5 text-[13px] bg-surface-base border border-white/[0.08] rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/30 disabled:opacity-60 transition-all duration-150"
            />
            <button
              onClick={() => handleSend()}
