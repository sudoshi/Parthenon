    ...
    <div className="flex-1 overflow-y-auto">
      ...
      {sorted.map((member) => {
        ...
        return (
          <div
            key={member.id}
            className="mx-3 mb-2 flex items-center gap-2.5 rounded-xl border border-border-default bg-surface-base px-3 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition-colors hover:border-surface-highlight hover:bg-surface-raised"
          >
