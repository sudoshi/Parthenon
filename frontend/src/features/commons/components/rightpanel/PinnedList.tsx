    ...
    <div className="flex-1 overflow-y-auto">
      <div className="space-y-2 p-3">
        {pins.map((pin) => (
          <div
            key={pin.id}
            className="group relative rounded-xl border border-border-default bg-surface-raised p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition-colors hover:border-surface-highlight"
          >
