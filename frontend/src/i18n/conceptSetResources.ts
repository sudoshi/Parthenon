...
const arConceptSet: MessageTree = mergeMessageTrees(enConceptSet, {
  conceptSets: {
    page: {
      title: "مجموعات المفاهيم",
      subtitle:
        "عرّف مجموعات مفاهيم قابلة لإعادة الاستخدام وأدرها لتعريفات المجموعات والتحليلات",
      searchPlaceholder: "ابحث في مجموعات المفاهيم...",
      untitledName: "مجموعة مفاهيم بلا عنوان",
      newConceptSet: "مجموعة مفاهيم جديدة",
      fromBundle: "من الحزمة",
      import: "استيراد",
    },
    list: {
      failedToLoad: "تعذر تحميل مجموعات المفاهيم",
      emptyTitle: "لا توجد مجموعات مفاهيم",
      emptyMessage: "أنشئ أول مجموعة مفاهيم لبدء بناء التعريفات.",
      noMatchingTitle: "لا توجد مجموعات مفاهيم مطابقة",
      noMatchingMessage: "حاول تعديل البحث أو مرشحات الوسوم.",
      myConceptSets: "مجموعات مفاهيمي",
      allConceptSets: "كل مجموعات المفاهيم",
    ...
    builder: {
      ...
      setContents: "محتويات المجموعة",
      concept_one: "{{count}} مفهوم",
      concept_other: "{{count}} مفاهيم",
    },
    editor: {
      ...
      descendantsOn: "المتفرعات مفعلة",
      descendantsOff: "المتفرعات معطلة",
      mappedOn: "التعيينات مفعلة",
      mappedOff: "التعيينات معطلة",
      exclude: "استبعاد",
      include: "تضمين",
      resolvedTo_one: "تم الحل إلى {{count}} مفهوم",
      resolvedTo_other: "تم الحل إلى {{count}} مفاهيم",
      columns: {
        conceptId: "معرّف المفهوم",
        name: "الاسم",
        domain: "المجال",
        vocabulary: "المفردات",
        standard: "قياسي",
      ...
      emptyTitle: "لم تتم إضافة مفاهيم بعد",
      emptyMessage:
        "استخدم لوحة البحث للعثور على مفاهيم وإضافتها إلى هذه المجموعة",
      toggleLabels: {
        excludeConcept: "استبعاد المفهوم",
        includeDescendants: "تضمين المتفرعات",
        includeMapped: "تضمين المعيّنات",
        removeItem: "إزالة العنصر",
      },
    },
    detail: {
      failedToLoad: "تعذر تحميل مجموعة المفاهيم",
      backToList: "العودة إلى القائمة",
      clickToEdit: "انقر للتحرير",
      addDescription: "أضف وصفًا...",
      duplicate: "نسخ",
      duplicateSuccess: 'تم النسخ باسم "{{name}}"',
      duplicateFailed: "تعذر نسخ مجموعة المفاهيم",
      export: "تصدير",
      exportFallbackName: "مجموعة-مفاهيم",
      delete: "حذف",
      deleteConfirm: "هل أنت متأكد من أنك تريد حذف مجموعة المفاهيم هذه؟",
      recommendedConcepts: "المفاهيم الموصى بها",
      visibility: {
        public: "عام",
        private: "خاص",
      },
    ...
    detailTabs: {
      ...
      mapsFrom: "التعيينات من المصدر",
      failedToLoadConcept: "تعذر تحميل المفهوم",
      labels: {
      ...
      noAncestorsFound: "لم يتم العثور على أسلاف",
      noRelationshipsFound: "لم يتم العثور على علاقات",
      relationshipsPage: "الصفحة {{page}} من {{totalPages}} - الإجمالي {{total}}",
      noSourceCodes: "لا توجد رموز مصدر مرتبطة بهذا المفهوم",
      showingSourceCodes: "عرض {{shown}} من {{total}} من رموز المصدر",
    },
    stats: {
      total: "الإجمالي",
      withItems: "مع عناصر",
    ...
    phoebe: {
      recommendations: "توصيات Phoebe",
      poweredBy: "مدعوم بواسطة Phoebe",
      addAll_one: "إضافة الكل ({{count}})",
      addAll_other: "إضافة الكل ({{count}})",
      unavailable: "التوصيات غير متاحة",
      noneFound: "لم يتم العثور على توصيات",
      added: "تمت الإضافة",
      addToConceptSet: "أضف إلى مجموعة المفاهيم",
      add: "إضافة",
    },
    bundle: {
      title: "الإنشاء من حزمة رعاية",
      description:
        "اختر حزمة مرضية لإنشاء مجموعات مفاهيم تلقائيًا مجمعة حسب المجال (الحالات، الأدوية، القياسات).",
      filterPlaceholder: "رشّح الحزم...",
      noMatching: "لا توجد حزم مطابقة",
      noneFound: "لم يتم العثور على حزم رعاية",
      namePrefix: "بادئة الاسم",
      namingHelp:
        'ستُسمى المجموعات "{{name}} - الحالات"، و"- الأدوية"، وهكذا.',
      create: "إنشاء مجموعات مفاهيم",
      created_one: "تم إنشاء {{count}} مجموعة مفاهيم من {{bundle}}",
      created_other: "تم إنشاء {{count}} مجموعات مفاهيم من {{bundle}}",
      createFailed: "تعذر إنشاء مجموعات المفاهيم من الحزمة",
      measures_one: "{{count}} قياس",
      measures_other: "{{count}} قياسات",
      concepts_one: "{{count}} مفهوم",
      concepts_other: "{{count}} مفاهيم",
    },
    import: {
      title: "استيراد مجموعة مفاهيم",
      uploadJsonFile: "تحميل ملف JSON",
      chooseFile: "اختر ملفًا",
      pasteAtlasJson: "أو الصق JSON (بتنسيق Atlas)",
      placeholder:
        '{\n  "name": "مجموعة مفاهيمي",\n  "expression": { "items": [...] }\n}',
  ...
  shared: {
    significanceVerdict: {
      protective: "تأثير وقائي مهم",
      harmful: "تأثير ضار مهم",
      notSignificant: "غير ذو دلالة إحصائية",
    },
    workbench: {
      statusLabel: "الحالة:",
      ariaRunStatus: "حالة التشغيل",
      pollingEvery2s: "تحديث كل ثانيتين",
    },
    conceptSearch: {
      observationsShort: "ملاح",
    },
  },
});
