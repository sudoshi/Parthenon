...
const arPublishCareGapRisk: MessageTree = mergeMessageTrees(
  enPublishCareGapRisk,
  {
    riskScores: {
      common: {
        ...
        tier: {
          ...
          high: "مرتفع",
          veryHigh: "مرتفع جداً",
          uncomputable: "غير قابل للحساب",
          filtered: "مصفى",
          customFilter: "مرشح مخصص",
        },
        category: {
          cardiovascular: "القلب والأوعية الدموية",
          comorbidityBurden: "عبء الأمراض المصاحبة",
          hepatic: "كبدي",
          pulmonary: "رئوي",
          respiratory: "تنفسي",
          metabolic: "استقلابي",
          endocrine: "غدي صمّاوي",
        ...
        actions: {
          ...
          createCohort: "إنشاء مجموعة",
          createCohortFromFilter: "إنشاء مجموعة من المرشح",
          newAnalysis: "تحليل جديد",
          duplicateAnalysis: "تكرار التحليل",
          deleteAnalysis: "حذف التحليل",
          openCatalogue: "فتح الكتالوج",
          viewFullResults: "عرض النتائج الكاملة",
        },
        values: {
        ...
        search: {
          analysesPlaceholder: "ابحث في التحليلات...",
          noMatch: 'لا توجد تحليلات تطابق "{{query}}"',
          typeToFilter: "اكتب لتصفية {{count}} من التحليلات",
        },
        count: {
          cohort_one: "{{count}} مجموعة",
          cohort_other: "{{count}} مجموعات",
          score_one: "{{count}} درجة",
          score_other: "{{count}} درجات",
        ...
        pagination: {
          showingRange: "عرض {{from}}-{{to}} من أصل {{total}}",
          pageXOfY: "{{current}} / {{total}}",
        },
      },
      hub: {
        title: "تحليلات درجات المخاطر",
        subtitle: "صنّف مجموعات المرضى اعتماداً على درجات المخاطر السريرية المعتمدة",
        metrics: {
          total: "الإجمالي",
          running: "قيد التشغيل",
          completed: "مكتمل",
          scoresAvailable: "الدرجات المتاحة",
          patientsScored: "المرضى الذين تم تسجيلهم",
        },
        filters: {
          status: "الحالة",
          category: "الفئة",
        ...
        tabs: {
          analyses: "التحليلات",
          scoreCatalogue: "كتالوج الدرجات",
        },
        drilldown: {
          analyses: "تحليلات {{status}}",
        },
        empty: {
          noMatchingAnalyses: "لا توجد تحليلات مطابقة",
          noRiskScoreAnalysesYet: "لا توجد تحليلات لدرجات المخاطر بعد",
          noAnalysesFoundFor: 'لم يتم العثور على تحليلات لـ "{{query}}"',
          createFirst:
            "أنشئ أول تحليل لتصنيف المرضى باستخدام درجات المخاطر السريرية.",
        },
        errors: {
          failedToLoadAnalyses: "تعذر تحميل التحليلات. يرجى المحاولة مرة أخرى.",
        },
        catalogue: {
          checkingEligibility: "جارٍ التحقق من الأهلية...",
          showingEligibilityFor: "عرض الأهلية لـ {{source}}",
          eligibleSummary: "{{eligible}} من أصل {{total}} درجات مؤهلة",
          completedResults: "{{count}} نتائج مكتملة",
          selectSourcePrompt:
            "اختر مصدر بيانات من الرأس للتحقق من أهلية كل درجة.",
          sourceLevelCompletedScores: "الدرجات المكتملة على مستوى المصدر",
          sourceLevelCompletedScoresDetail:
            "توجد {{count}} درجة مكتملة للمصدر النشط لكنها غير مرتبطة بأي تنفيذ تحليل v2.",
          sourceLevelCompletedScoresDetail_other:
            "توجد {{count}} درجات مكتملة للمصدر النشط لكنها غير مرتبطة بأي تنفيذ تحليل v2.",
          eligibleCount: "{{count}} مؤهل",
          completedCount: "{{count}} مكتمل",
        },
      },
      create: {
        title: "تحليل جديد لدرجة المخاطر",
        subtitle: "هيئ تحليل تسجيل المخاطر واختر الدرجات المطلوب احتسابها",
        steps: {
          configure: "تهيئة",
          reviewAndRun: "مراجعة وتشغيل",
        },
        basics: "الأساسيات",
        name: "الاسم *",
        description: "الوصف",
        targetCohort: "المجموعة المستهدفة *",
        selectCohort: "اختر مجموعة...",
        scoreSelection: "اختيار الدرجات",
        cohortPatients: "{{count}} مرضى",
        autoNameSuffix: "تصنيف المخاطر",
        placeholders: {
          name: "مثال: مجموعة قصور القلب - تصنيف المخاطر",
          description: "وصف اختياري لتحليل تسجيل المخاطر هذا...",
        },
        completeness: "الاكتمال:",
        createAsDraft: "إنشاء كمسودة",
        createAndRun: "إنشاء وتشغيل",
        errors: {
          executionFailed:
            "تم إنشاء التحليل لكن التنفيذ فشل. يمكنك إعادة تشغيله من صفحة التفاصيل.",
          createFailed: "تعذر إنشاء التحليل. يرجى المحاولة مرة أخرى.",
        },
        recommendations: {
          recommended: "موصى به",
          available: "متاح",
      ...
      detail: {
        ...
        backToRiskScores: "العودة إلى درجات المخاطر",
        selectSourcePrompt:
          "اختر مصدر بيانات لتشغيل النتائج التنفيذية أو عرضها.",
        deleteConfirm:
      ...
      overview: {
        about: "حول",
        author: "المؤلف: {{value}}",
        created: "تاريخ الإنشاء: {{value}}",
        updated: "تاريخ التحديث: {{value}}",
        resultsSummary: "ملخص النتائج",
        scoresComputed: "الدرجات المحتسبة",
        uniqueScores: "درجات فريدة",
        patientsScored: "المرضى الذين تم تسجيلهم",
        maxPerScore: "أقصى عدد لكل درجة",
        avgCompleteness: "متوسط الاكتمال",
        avgConfidence: "متوسط الثقة",
        acrossSummaries: "عبر الملخصات",
        thisAnalysisHasNotBeenExecutedYet: "لم يتم تنفيذ هذا التحليل بعد.",
        executionInProgress: "التنفيذ جارٍ...",
        lastExecutionFailed: "فشل آخر تنفيذ.",
        recentExecution: "أحدث تنفيذ",
        started: "بدأ",
        completed: "اكتمل",
        duration: "المدة",
      },
      configuration: {
        analysisDesign: "تصميم التحليل",
        targetCohorts: "المجموعات المستهدفة",
        selectedScores: "الدرجات المختارة",
        parameters: "المعلمات",
        minCompleteness: "أدنى اكتمال:",
        storePatientLevel: "تخزين على مستوى المريض:",
        executionHistory: "سجل التنفيذ",
        noExecutionsYet: "لا توجد عمليات تنفيذ بعد",
      },
      results: {
        noResultsAvailable:
          "لا توجد نتائج متاحة. شغّل التحليل لاحتساب درجات المخاطر.",
        allScores: "كل الدرجات",
        percentOfTotal: "% من الإجمالي",
        action: "الإجراء",
        averageCompleteness: "متوسط الاكتمال:",
      },
      patients: {
        noExecutionSelected: "لم يتم اختيار تنفيذ",
        runExecutionToViewPatientLevel:
          "شغّل تنفيذًا لعرض النتائج على مستوى المريض.",
        all: "الكل",
        showingPatients: "عرض {{count}} مريضاً",
        patientsOnPage: "{{count}} مرضى في هذه الصفحة",
        noPatientResultsAvailable: "لا توجد نتائج مرضى متاحة",
        adjustFilters: "جرّب تعديل عوامل التصفية لرؤية النتائج.",
        executeToGenerate:
          "نفّذ التحليل لتوليد الدرجات على مستوى المريض.",
        personId: "معرّف الشخص",
      },
      scoreDetail: {
        selectSourcePrompt:
          "اختر مصدر بيانات من الرأس للتحقق من الأهلية.",
        eligiblePatients: "مؤهل - لدى {{count}} مرضى بيانات كافية",
        insufficientData: "البيانات غير كافية في المصدر النشط",
        missing: "المفقود:",
        checkingEligibility: "جارٍ التحقق من الأهلية للمصدر النشط...",
        eligiblePopulation: "السكان المؤهلون",
        requiredComponents: "المكونات المطلوبة",
        cdmTablesUsed: "جداول CDM المستخدمة",
        riskTierDefinitions: "تعريفات فئات الخطر",
        scoreRange: "نطاق الدرجة",
      },
      createCohort: {
        title: "إنشاء مجموعة من فئة الخطر",
        cohortName: "اسم المجموعة",
        description: "الوصف",
        patientsIncluded: "سيتم تضمين {{count}} مريضاً",
        ...
        score: "الدرجة:",
        tier: "الفئة:",
        createFailed: "تعذر إنشاء المجموعة. يرجى المحاولة مرة أخرى.",
        derivedDescription:
          "مرضى من المجموعة '{{cohort}}' لديهم فئة خطر {{score}} = {{tier}}",
        defaultName: "{{score}} - خطر {{tier}} - {{cohort}}",
      },
      recommendations: {
        selectSourceToView: "اختر مصدراً لعرض التوصيات",
        recommended: "موصى به",
        available: "متاح",
        notApplicable: "غير منطبق",
      },
      runModal: {
        title: "درجات مخاطر السكان",
        computingScores: "جارٍ احتساب الدرجات...",
        completedScoresIn: "اكتمل احتساب {{count}} درجة خلال {{duration}}",
        completedScoresIn_other:
          "اكتمل احتساب {{count}} درجات خلال {{duration}}",
        runFailed: "فشل التشغيل",
        passed: "{{count}} ناجحة",
        failed: "{{count}} فاشلة",
        skipped: "{{count}} متخطاة",
        seconds: "ثوانٍ",
        tiers: "{{count}} فئات",
      },
      tierBreakdown: {
        tierDistribution: "توزيع الفئات",
        patientsPerTier: "المرضى لكل فئة",
        patients: "المرضى",
      },
      cohortProfile: {
        ...
        age: "العمر",
        female: "{{count}}% إناث",
        topConditions: "أهم الحالات",
        measurementCoverage: "تغطية القياسات",
      },
    },
    publish: {
      common: {
        actions: {
          ...
          configureDocument: "تهيئة المستند ->",
          close: "إغلاق",
        },
        sectionType: {
          title: "عنوان",
        ...
        analysisType: {
          characterizations: "التوصيف",
          characterization: "التوصيف",
          estimations: "التقدير",
          estimation: "التقدير",
          predictions: "التنبؤ",
          prediction: "التنبؤ",
          incidence_rates: "معدل الحدوث",
          incidence_rate: "معدل الحدوث",
          sccs: "SCCS",
          evidence_synthesis: "تركيب الأدلة",
          pathways: "المسار",
          pathway: "المسار",
        },
        resultSection: {
          ...
          treatmentPatterns: "أنماط العلاج",
          safetyAnalysis: "تحليل السلامة",
      ...
      tables: {
        captions: {
          incidenceRatesByCohort: "معدلات الحدوث حسب المجموعة",
          comparativeEffectivenessEstimates: "تقديرات الفعالية المقارنة",
          sccsEstimates:
            "سلسلة الحالات ذاتية الضبط: نسب معدل الحدوث بحسب نافذة التعرض",
          treatmentPathways: "مسارات العلاج (أهم 10)",
          populationCharacteristics: "خصائص السكان",
          predictionModelPerformance: "أداء نموذج التنبؤ",
          evidenceSynthesisPooled: "تركيب الأدلة: التقديرات المجمعة",
        },
        headers: {
          cohort: "المجموعة",
          outcome: "النتيجة",
          ...
          ratePer1000Py: "المعدل/1000 PY",
          confidence95: "فاصل الثقة 95%",
          hazardRatioShort: "HR",
          pValue: "قيمة p",
          exposureWindow: "نافذة التعرض",
          irr: "IRR",
          pathway: "المسار",
          patients: "المرضى",
          percent: "%",
          ...
          model: "النموذج",
          auc: "AUC",
          brierScore: "درجة Brier",
          auprc: "AUPRC",
          targetN: "عدد المستهدفين",
          outcomeN: "عدد النتائج",
          analysis: "التحليل",
          pooledEstimate: "التقدير المجمع",
          iSquaredShort: "I²",
        },
        values: {
          cohort: "المجموعة",
      ...
      templates: {
        "generic-ohdsi": {
          name: "منشور OHDSI عام",
          description:
            "بنية IMRaD القياسية لدراسات البيانات الصحية الرصدية",
          sections: {
        ...
        "comparative-effectiveness": {
          name: "تقرير الفعالية المقارنة",
          description: "بنية CLE/CER مع تحليل درجات الميل",
          sections: {
            background: "الخلفية",
            "study-design": "تصميم الدراسة",
            "ps-matching": "مطابقة درجة الميل",
            covariates: "توازن المتغيرات المشتركة",
            "sensitivity-analyses": "تحليلات الحساسية",
            discussion: "المناقشة",
          },
        },
        "incidence-report": {
          name: "تقرير معدل الحدوث",
          description: "تحليل الحدوث على مستوى السكان",
          sections: {
            background: "الخلفية",
            methods: "المنهجية",
            discussion: "المناقشة",
        ...
        "study-protocol": {
          name: "بروتوكول الدراسة / SAP",
          description:
            "خطة تحليل إحصائي قبل الدراسة من دون الحاجة إلى نتائج",
          sections: {
            objectives: "الأهداف",
            hypotheses: "الفرضيات",
            "study-design": "تصميم الدراسة",
            "data-sources": "مصادر البيانات",
            "cohort-definitions": "تعريفات المجموعات",
            "analysis-plan": "خطة التحليل",
        ...
        "jamia-style": {
          name: "نمط JAMIA",
          description:
            "مجلة Journal of the American Medical Informatics Association مع تركيز منهجي على المعلوماتية وقابلية إعادة الإنتاج",
          sections: {
            "background-significance": "الخلفية والأهمية",
            objective: "الهدف",
            "materials-methods": "المواد والمنهجية",
            "data-sources": "مصادر البيانات ومجتمع الدراسة",
            "phenotype-definitions": "تعريفات الصفات الظاهرية",
        ...
        "lancet-style": {
          name: "نمط Lancet",
          description:
            "نمط The Lancet مع تركيز صحي عالمي ومنهجية منظمة وتفسير مبني على الأدلة وآثار سياساتية",
          sections: {
            introduction: "المقدمة",
            methods: "المنهجية",
            "study-design-participants": "تصميم الدراسة والمشاركون",
            procedures: "الإجراءات",
            outcomes: "النتائج",
            "statistical-analysis": "التحليل الإحصائي",
            "role-of-funding": "دور جهة التمويل",
            discussion: "المناقشة",
          },
        },
        "nejm-style": {
          name: "نمط NEJM",
          description:
            "نمط New England Journal of Medicine مع تركيز سريري موجز واقتصاد صارم في الكلمات",
          sections: {
            introduction: "المقدمة",
            methods: "المنهجية",
            "study-design": "تصميم الدراسة والإشراف",
            patients: "المرضى",
        ...
        "himss-poster": {
          name: "ملصق HIMSS",
          description:
            "ملصق مؤتمر HIMSS مع لوحات موجزة للخلفية والمنهجية والنتائج الأساسية وبيان الأثر",
          sections: {
            background: "الخلفية",
            "problem-statement": "صياغة المشكلة",
            objectives: "الأهداف",
            methods: "المنهجية",
            "key-findings": "النتائج الأساسية",
            "clinical-impact": "الأثر السريري والتشغيلي",
