...
beforeEach(function () {
    ...
    // The inpatient_ext schema + morpheus_dataset table are created by
    // migration 2026_04_10_000001 against the default testing connection
    // (pgsql_testing → parthenon_testing), and Morpheus services + controllers
    // read the registry via the 'inpatient_testing' connection which also
    // targets parthenon_testing. We just need to seed an active fixture row.
