...
class ClinicalSearchService
{
    ...
    public function search(string $query, array $filters = [], int $limit = 50, int $offset = 0): ?array
    {
        ...
        $params = [
            ...
            'start' => $offset,
            'rows' => $limit,
            'fl' => 'event_id,event_type,person_id,concept_id,concept_name,domain_id,vocabulary_id,event_date,event_end_date,source_id,source_name,value_as_number,value_as_string,unit,type_concept_name',
            'hl' => 'true',
            'hl.fl' => 'concept_name,value_as_string',
            'hl.simple.pre' => '<mark>',
            'hl.simple.post' => '</mark>',
            'facet' => 'true',
