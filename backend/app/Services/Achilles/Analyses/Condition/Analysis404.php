...
/**
 * Analysis 404: Number of persons with condition by condition_concept_id by age decile.
 */
class Analysis404 implements AchillesAnalysisInterface
{
    ...
    {
        return 'Number of persons with condition by condition_concept_id by age decile';
    }
    ...
    {
        return <<<'SQL'
            DELETE FROM {@resultsSchema}.achilles_results WHERE analysis_id = 404;
            ...
            SELECT 404 AS analysis_id,
                ...
                CAST(FLOOR((EXTRACT(YEAR FROM co.condition_start_date) - p.year_of_birth) / 10) AS VARCHAR(255)) AS stratum_2,
