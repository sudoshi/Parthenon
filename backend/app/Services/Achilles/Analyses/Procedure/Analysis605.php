...
/**
 * Analysis 605: Distribution of age at first procedure occurrence, by gender.
 */
class Analysis605 implements AchillesAnalysisInterface
{
    ...
    {
        return 'Distribution of age at first procedure occurrence by gender';
    }
    ...
    {
        return <<<'SQL'
            DELETE FROM {@resultsSchema}.achilles_results_dist WHERE analysis_id = 605;
