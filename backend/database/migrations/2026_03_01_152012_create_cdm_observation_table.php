...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('observation')) {
            return;
        }

        Schema::connection('omop')->create('observation', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('observation');
    }
};
