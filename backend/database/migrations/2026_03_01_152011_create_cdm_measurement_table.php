...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('measurement')) {
            return;
        }

        Schema::connection('omop')->create('measurement', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('measurement');
    }
};
