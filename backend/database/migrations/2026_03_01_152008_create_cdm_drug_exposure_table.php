...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('drug_exposure')) {
            return;
        }

        Schema::connection('omop')->create('drug_exposure', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('drug_exposure');
    }
};
