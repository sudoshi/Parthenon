...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('care_site')) {
            return;
        }

        Schema::connection('omop')->create('care_site', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('care_site');
    }
};
