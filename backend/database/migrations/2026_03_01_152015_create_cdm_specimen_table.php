...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('specimen')) {
            return;
        }

        Schema::connection('omop')->create('specimen', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('specimen');
    }
};
