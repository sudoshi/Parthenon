...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('omop')->hasTable('location')) {
            return;
        }

        Schema::connection('omop')->create('location', function (Blueprint $table) {
    ...
    {
        Schema::connection('omop')->dropIfExists('location');
    }
};
