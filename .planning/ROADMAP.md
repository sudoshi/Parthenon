...
**Plans**: 11 plans (9 shipped + 2 gap-closure from 15-REVIEW.md)
...
- [x] 15-07-PLAN.md — Wave 4: FinnGenEndpointBrowserPage drawer wiring + Phase 16 stub route
...
- [x] 18-05-PLAN.md — Wave 3: finngen_endpoint_profile_execute() R worker (KM survfit + Matrix::crossprod phi + ATC3 SQL) + routes.R dispatcher
- [x] 18-06-PLAN.md — Wave 4: React — api.ts types + 3 hooks + 5 Profile panels + heatmap-helpers + FinnGenEndpointBrowserPage tab wiring
...
| 18. Risteys-style Endpoint Dashboard | 6/7 | In Progress|  |
