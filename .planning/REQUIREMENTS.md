...
- [ ] **FOUND-01**: ETL shared library provides tested date assembly from split columns (Month-text, Day-int, Year-int) with imputation rules matching Final_Queries.sql logic
...
- [ ] **VISIT-03**: Visit lookup map (visit_id_map.csv) produced for all clinical event scripts to reference
