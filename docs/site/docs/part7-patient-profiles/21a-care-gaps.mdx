...
- [Patient Timelines](/part7-patient-profiles/21-patient-timelines) — View individual patient clinical histories
- [Concept Sets](/part2-vocabulary/04-concept-sets) — Define the clinical criteria used by quality measures
- [Cohort Definitions](/part3-cohorts/06-building-cohorts) — Build patient cohorts for targeted compliance analysis
