...
5. Once verified, begin migrating cohort definitions and concept sets using the import tools described in the [Migration Guide](/migration/overview).
...
- [Data Sources](/data-sources) -- manage all CDM data source connections
- [Migration Guide](/migration/overview) -- full guide for migrating from Atlas/WebAPI to Parthenon
- [System Configuration](/system-configuration) -- platform-wide administration settings
