...
- [System Configuration](/part8-administration/25-system-configuration) -- general platform settings and mail configuration
- [Abby AI Assistant](/part8-administration/28-abby-ai-assistant) -- using the AI assistant in cohort building and concept search
