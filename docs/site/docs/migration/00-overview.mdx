...
See [Chapter 6 --- Feature Comparison](./06-feature-comparison) for the complete feature-by-feature mapping.
...
See [Chapter 1 --- Before You Begin](./01-before-you-begin) for the full prerequisite checklist.
