...
:::tip Post-Import: Explore New Features
After importing your Atlas artefacts, consider exploring Parthenon's new capabilities that go beyond Atlas: Genomics (VCF upload), Imaging (DICOM viewer), HEOR (cost-effectiveness), and FHIR EHR integration. See the [Feature Comparison](06-feature-comparison) for the full list.
:::
