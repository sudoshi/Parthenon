...
:::info New Modules Do Not Require Migration
...
- Legacy Atlas URLs (`/atlas/#/...` and `/WebAPI/...`) are automatically redirected to Parthenon equivalents by the built-in redirect layer. Existing bookmarks continue to work.
