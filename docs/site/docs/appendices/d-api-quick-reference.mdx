...
Parthenon exposes a REST API at `/api/v1/`. Full interactive documentation is available at [/docs/api](https://parthenon.acumenus.net/docs/api) (powered by Scramble). This appendix provides a quick reference for all endpoints organized by module.
