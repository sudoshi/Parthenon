...
- [Building Cohorts](/part3-cohorts/06-building-cohorts) -- manually create cohort definitions
- [Concept Sets](/part2-vocabulary/04-concept-sets) -- build concept sets used in phenotype expressions
