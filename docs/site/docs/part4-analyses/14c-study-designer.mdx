...
See [Roles & Permissions](../part8-administration/23-roles-permissions.mdx) for full role configuration.
...
- Check that cohort generation completed successfully (see [Jobs Monitoring](../part5-ingestion/18-jobs-monitoring.mdx)).
...
- [Studies](./14-studies.mdx) — managing and executing study packages
- [Study Packages](./14d-study-packages.mdx) — detailed package format reference
- [Phenotype Library](./14e-phenotype-library.mdx) — importing validated phenotypes into Study Designer
- [Evidence Synthesis](./14b-evidence-synthesis.mdx) — aggregating results across network sites
- [Abby AI Assistant](../part8-administration/28-abby-ai-assistant.mdx) — configuring AI providers used by Study Designer
