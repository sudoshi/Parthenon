...
- [Population-Level Estimation](/part4-analyses/12-population-level-estimation) -- source analyses that feed into evidence synthesis
- [SCCS](/sccs) -- self-controlled case series results can be pooled here
- [Studies](/part4-analyses/14-studies) -- multi-database study orchestration
