...
- [Studies](/part4-analyses/14-studies) -- high-level study orchestration
- [Population-Level Estimation](/part4-analyses/12-population-level-estimation) -- CohortMethod analysis design
- [SCCS](/sccs) -- self-controlled case series design
- [Patient-Level Prediction](/part4-analyses/13-patient-level-prediction) -- prediction model design
