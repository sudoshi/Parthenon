...
- [Data Sources](/part1-getting-started/02-data-sources) -- configure and manage CDM database connections
- [Data Explorer](/part6-data-explorer/18-characterization-achilles) -- full CDM characterization with Achilles
- [Cohort Definitions](/part3-cohorts/06-building-cohorts) -- create and manage cohort definitions
- [Concept Sets](/part2-vocabulary/04-concept-sets) -- build and maintain concept sets
- [Data Quality Dashboard](/part6-data-explorer/19-data-quality-dashboard) -- detailed data quality assessment
- [User Management](/part8-administration/22-user-management) -- manage team members and access
